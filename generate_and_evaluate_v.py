...
def generate_and_evaluate(
    ...
    enforce_eager=False,   # Set True to disable torch.compile/cudagraph for debug prints
):    
    ...
    def create_llm(steering_strength, steering_vector_path, model_path, tensor_parallel_size=1):
        ...
        if steering_enabled:
            ...
            #steering_strength_list[12] = base_strength
            #steering_strength_list[13] = base_strength
            #steering_strength_list[14] = base_strength
            #steering_strength_list[15] = base_strength
            #steering_strength_list[16] = base_strength
