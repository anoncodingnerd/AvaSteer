...
base_save_path="./Data/Eval_Split_Calib_droplast/${dataname}/${model_basename}_olympiad_7_8_9_10_11"
...
echo "Running generate_and_evaluate_olympiad_v.py with following parameters:"
...
python generate_and_evaluate_olympiad_v.py \
  --dataname "$dataname" \
  --data_path "$data_path" \
