...
def generate_and_evaluate(
    ...
    """
    if "stop_token_ids" in available_params:
        eos_id = getattr(tokenizer, "eos_token_id", None)
        if eos_id is not None:
            sampling_args["stop_token_ids"] = [eos_id]
    """
    ...
    def create_llm(steering_strength, steering_vector_path, model_path, tensor_parallel_size=1):
        ...
        if steering_enabled:
            ...
            steering_strength_list[7] = base_strength
            steering_strength_list[8] = base_strength
            steering_strength_list[9] = base_strength
            steering_strength_list[10] = base_strength
            steering_strength_list[11] = base_strength
            #steering_strength_list[32] = base_strength
            #steering_strength_list[33] = base_strength
            #steering_strength_list[34] = base_strength
            #steering_strength_list[35] = base_strength
            #steering_strength_list[36] = base_strength
